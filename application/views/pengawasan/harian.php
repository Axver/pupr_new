					...
					<div class="col-xl-12 col-lg-12">
						<div class="card shadow mb-12">
							...
							<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
								<h6 class="m-0 font-weight-bold text-primary">Laporan Harian Users</h6>
...
//							        echo $count;
							        ...
							        while($i<$count)
									{
										$data=$this->db->get_where("lap_harian_mingguan",array("id_paket"=>$id_paket[$i]->id_paket))->result();
										$jumlah=count($data);
										$j=0;
										while($j<$jumlah)
										{
											?>
									       <tr>
											   <td><?php echo $data[$j]->id_lap_harian_mingguan; ?></td>
