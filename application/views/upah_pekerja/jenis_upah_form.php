...
<div id="wrapper">
	...
	<div id="content-wrapper" class="d-flex flex-column">
					...
					<div class="col-xl-12 col-lg-12">
						<div class="card shadow mb-12">
							...
							<div class="card-body">
								...
								<b style="color:darkgreen">Tambah Upah Baru</b>
	    ...
	    <input type="hidden" name="id_jenis_upah" value="<?php echo $id_jenis_upah; ?>" /> 
	    <button type="submit" class="btn btn-primary"><?php echo $button ?></button> 
	    <a href="<?php echo site_url('upah_pekerja') ?>" class="btn btn-default">Cancel</a>
	</form>
