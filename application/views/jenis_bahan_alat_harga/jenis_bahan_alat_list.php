						...
						<div class="card shadow mb-12">
							...
							<div class="card-body">
								...
								<table class="table table-bordered" id="example" style="margin-bottom: 10px">
									...
									<?php
									foreach ($jenis_bahan_alat_harga_data as $jenis_bahan_alat_harga)
									{
										?>
										<tr>
											<td width="80px"><?php echo ++$start ?></td>
											<td><?php echo $jenis_bahan_alat_harga->jenis_bahan_alat ?></td>
											<td><?php echo $jenis_bahan_alat_harga->harga ?></td>
											<td style="text-align:center" width="200px">
												<?php
												echo anchor(site_url('jenis_bahan_alat_harga/read/'.$jenis_bahan_alat_harga->id_jenis_bahan_alat),'Read');
												echo ' | ';
												echo anchor(site_url('jenis_bahan_alat_harga/update/'.$jenis_bahan_alat_harga->id_jenis_bahan_alat),'Update');
												echo ' | ';
												echo anchor(site_url('jenis_bahan_alat_harga/delete/'.$jenis_bahan_alat_harga->id_jenis_bahan_alat),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"');
												?>
											</td>
										</tr>
										<?php
