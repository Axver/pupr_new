						...
						<div class="card shadow mb-12">
							...
							<div class="card-body">
								...
								<table id="example" class="display" style="width:100%">
									...
									<?php
									foreach ($lap_perencanaan_force_data as $lap_perencanaan_force)
									{
										?>
										<tr>
											<td width="80px"><?php echo ++$start ?></td>
											<td><?php echo $lap_perencanaan_force->tukang ?></td>
											<td><?php echo $lap_perencanaan_force->pekerja ?></td>
											<td><?php echo $lap_perencanaan_force->lokasi ?></td>
											<td><?php echo $lap_perencanaan_force->jenis_pekerjaan ?></td>
											<td><?php echo $lap_perencanaan_force->panjang_penanganan ?></td>
											<td><?php echo $lap_perencanaan_force->keterangan_dimensi ?></td>
											<td><?php echo $lap_perencanaan_force->keterangan ?></td>
