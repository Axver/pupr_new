...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 24 Nov 2019 pada 03.23
...
CREATE TABLE `detail_bahan_alat_harian` (
  ...
  `jumlah_tukang` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
('2019-11-01', '1', '1', '2019', '1', '1', '5', '1', '10', '', '', '', '', '', '4'),
('2019-11-01', '1', '1', '2019', '1', '2', '76', '15', '10', '', '', '', '', '', '7'),
('2019-11-01', '1', '1', '2019', '2', '1', '2', '2', '4', '', '', '', '', '', '8'),
